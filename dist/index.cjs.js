...
var ListDropdown = function (_a) {
    ...
    return (jsxRuntime.jsx("ul", __assign({ className: "options scrollbar-hide" }, { children: sortedOptions.length > 0 ? (sortedOptions.map(function (option, index) {
            ...
            return (jsxRuntime.jsxs("li", __assign({ className: clsx('options__item justify-between', {
                ...
                }), onClick: optionValue ? function () { return handleSelect(optionValue, optionLabel); } : undefined, onMouseEnter: function () { return setHoveredItemValue(index); }, onMouseLeave: function () { return setHoveredItemValue(null); } }, { children: [jsxRuntime.jsxs("div", __assign({ className: "justify-start" }, { children: [jsxRuntime.jsx(CircleUserRound, { className: "w-4 h-4", strokeWidth: isHoveringItem }), jsxRuntime.jsx("span", __assign({ className: "text-gray-900" }, { children: optionLabel }))] })), jsxRuntime.jsx(Check, { size: 12, color: isCurrentItem || isSelectingItem ? 'var(--color-success)' : 'var(--color-white)' })] }), "".concat(optionValue, "-").concat(index)));
...
var DropdownSelector = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: clsx('relative px-2 mt-5 bg-white', formGroupWidth), ref: containerRef }, { children: [jsxRuntime.jsxs("div", __assign({ className: "form--group" }, { children: [jsxRuntime.jsx("input", { type: "text", className: clsx('input', {
                        ...
                        }), htmlFor: "custom-dropdown" }, { children: labelText }))), jsxRuntime.jsx("div", __assign({ className: "right-2.5 absolute-center-y" }, { children: jsxRuntime.jsx(ChevronUp, { className: clsx('w-4 h-4', {
...
var Alert = function (_a) {
    ...
    switch (type) {
        case 'info':
            icon = jsxRuntime.jsx(BadgeInfo, {});
            break;
        case 'warning':
            icon = jsxRuntime.jsx(CircleAlert, {});
            break;
        case 'error':
            icon = jsxRuntime.jsx(X, {});
            break;
        case 'success':
            icon = jsxRuntime.jsx(BadgeCheck, {});
            break;
    }
...
var PasswordInput = react.forwardRef(function InputWithRef(_a, ref) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: clsx('relative px-2 mt-5 bg-white', fullWidth && 'w-full') }, { children: [jsxRuntime.jsxs("div", __assign({ className: "form--group" }, { children: [jsxRuntime.jsx("input", __assign({ type: hiddenPassword ? 'password' : 'text', ref: ref, className: clsx('input', {
                            ...
                            }), onClick: function () { return !disabled && setHiddenPassword(!hiddenPassword); } }, { children: hiddenPassword ? (jsxRuntime.jsx(EyeOff, { size: 24 })) : (jsxRuntime.jsx(Lock, { size: 24 })) })) }))] })), (hint && !error) && (jsxRuntime.jsx("span", __assign({ className: "mt-1 ml-1 text-xs text-gray-600" }, { children: hint }))), error && (jsxRuntime.jsx("div", __assign({ className: "mt-1 ml-1 text-xs text-danger" }, { children: error })))] })));
});

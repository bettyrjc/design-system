...
function ChevronUpIcon(_a) {
    ...
    return (jsxRuntime.jsxs("svg", __assign({ className: className, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, { children: ["  ", jsxRuntime.jsx("polyline", { points: "18 15 12 9 6 15" })] })));
}
...
var DropdownSelector = function (_a) {
    ...
    var _f = react.useState([]), sortedOptions = _f[0], setSortedOptions = _f[1];
    var _g = react.useState(null), selectingItem = _g[0], setSelectingItem = _g[1];
    var _h = react.useState(null), hoveredItemValue = _h[0], setHoveredItemValue = _h[1];
    var _j = react.useState(null), defaultValue = _j[0], setDefaultValue = _j[1];
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "relative px-2 mt-5 bg-white ".concat(formGroupWidth), ref: containerRef }, { children: [jsxRuntime.jsxs("div", __assign({ className: "form--group", onClick: function () { return setIsDropdownOpen(!isDropdownOpen); } }, { children: [jsxRuntime.jsx("input", { type: "text", className: "input ".concat(inputStyles), placeholder: " ", value: (selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.label) && (selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.label), readOnly: true, id: "custom-dropdown", ref: inputRef, disabled: isDisabled }), labelText && jsxRuntime.jsx("label", __assign({ className: labelStyles, htmlFor: "custom-dropdown" }, { children: labelText })), jsxRuntime.jsx("div", __assign({ className: "right-2.5 absolute-center-y" }, { children: jsxRuntime.jsx(ChevronUpIcon, { className: "".concat(toggleIconInput, " w-4 h-4 cursor-pointer") }) }))] })), hintText && !isDropdownOpen && jsxRuntime.jsx("span", __assign({ className: "mt-1 ml-1 | ".concat(hintStyles, " text-xs") }, { children: hintText })), isDropdownOpen && (jsxRuntime.jsx("ul", __assign({ className: "options scrollbar-hide" }, { children: sortedOptions.length > 0
                    ? sortedOptions === null || sortedOptions === void 0 ? void 0 : sortedOptions.map(function (option, index) {
                        ...
                        var checkIconStyles = isCurrentItem || isSelectingItem // only show when item have been selected
                            ...
                            : 'hidden ';
                        return (jsxRuntime.jsxs("li", __assign({ className: selectedItemStyles, onClick: optionValue ? function () { return handleSelect(optionValue, optionLabel); } : undefined, onMouseEnter: function () { return setHoveredItemValue(index); }, onMouseLeave: function () { return setHoveredItemValue(null); } }, { children: [jsxRuntime.jsxs("div", __assign({ className: 'justify-start' }, { children: [jsxRuntime.jsx(UserRoundedIcon, { className: "w-4 h-4", strokeWidth: isHoveringItem }), jsxRuntime.jsx("span", __assign({ className: "text-gray-900" }, { children: optionLabel }))] })), jsxRuntime.jsx(CheckIncon, { className: checkIconStyles })] }), "".concat(optionValue, "-").concat(index)));
                    })
